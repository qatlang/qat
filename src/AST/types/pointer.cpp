...
PointerType::PointerType(utils::FilePlacement _filePlacement)
    : type(VoidType(_filePlacement)), QatType(_filePlacement) {}

PointerType::PointerType(QatType _type, utils::FilePlacement _filePlacement)
    : type(_type), QatType(_filePlacement) {}

...
class BringBitwidths : public Node {
  ...
  public:
	BringBitwidths(Vec<ast::Type*> _broughtTypes, FileRangePtr _fileRange)
	    : Node(_fileRange), broughtTypes(_broughtTypes) {}

	useit static BringBitwidths* create(Vec<ast::Type*> _broughtTypes, FileRangePtr _fileRange) {

...
class QatModule {
public:
  QatModule(std::string _name, std::string _filename, llvm::LLVMContext &ctx,
...
private:
  ...
  /**
   *  LLVM Module generated by this module
   *
   */
  llvm::Module *mod;
  ...
  static QatModule *CreateSubmodule(QatModule *parent, std::string _filename,
...
public:
  ...
  static QatModule *Create(std::string name, std::string filename,

...
protected:
  ...
  // Whether this function returns a reference to another value
  bool returns_reference;

  // The LLVM Function generated by this function
  ...
  Function(llvm::Module *mod, std::string _parentName, std::string _name,
           QatType *returnType, bool _is_async, std::vector<Argument> _args,
           bool has_variadic_arguments, bool _returns_reference,
           utils::FilePlacement placement,
           utils::VisibilityInfo _visibility_info);

public:
  // Create a member function for the provided parent type
  static Function *Create(llvm::Module *mod, const std::string parentName,
  ...
  llvm::CallInst *
  call(llvm::IRBuilder<llvm::ConstantFolder, llvm::IRBuilderDefaultInserter>
           &builder,
       llvm::ArrayRef<llvm::Value *> args, utils::RequesterInfo req_info) const;

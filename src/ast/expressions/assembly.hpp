...
class InlineAssembly : public Expression {
  ...
  public:
	...
	static InlineAssembly* create(Type* functionType, PrerunExpression* asmValue, Vec<Expression*> arguments,
	                              FileRangePtr argsRange, PrerunExpression* clobbers, Maybe<FileRangePtr> volatileRange,
	                              PrerunExpression* volatileExp, FileRangePtr fileRange) {
	...
	NodeType nodeType() const final { return NodeType::INLINE_ASSEMBLY; }
};

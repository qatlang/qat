...
MemberFunction *
MemberFunction::Create(CoreType *parent, const bool is_variation,
                       const String name, QatType *returnTy,
                       const bool _isReturnTypeVariable, const bool _is_async,
...
MemberFunction *
MemberFunction::CreateStatic(CoreType *parent, const String name,
...
void MemberFunction::defineLLVM(llvmHelper &help) const {}

void MemberFunction::defineCPP(cpp::File &file) const {}

llvm::Value *MemberFunction::emitLLVM(llvmHelper &help) const {}

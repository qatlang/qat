...
void EmitCtx::name_check_in_module(const Identifier& name, const String& entityType, Maybe<String> genericID,
  ...
  if (mod->has_opaque_type(name.value, reqInfo)) {
    ...
    Error("A mix type named " + color(name.value) + " exists in this module. Please change name of this " + entityType +
              " or check the codebase for inconsistencies",
          name.range);
    ...
    Error("A type definition named " + color(name.value) + " is brought into this module. Please change name of this " +
              entityType + " or check the codebase for inconsistencies",
          name.range);
    ...
    Error("A function named " + color(name.value) + " exists in this module. Please change name of this " + entityType +
              " or check the codebase for inconsistencies",
          name.range);
    ...
    Error("A global named " + color(name.value) + " exists in this module. Please change name of this " + entityType +
              " or check the codebase for inconsistencies",
          name.range);
    ...
    Error("A prerun global named " + color(name.value) + " is brought into this module. Please change name of this " +
              entityType + " or check the codebase for inconsistencies",
          name.range);
    ...
    Error("A region named " + color(name.value) + " exists in this module. Please change name of this " + entityType +
              " or check the codebase for inconsistencies",
          name.range);
    ...
    switch (spec->kind) {
      ...
      case VisibilityKind::type: {
        if (has_member_parent()) {
          ...
          Error("There is no parent type and hence " + color("type") + " visibility cannot be used here", spec->range);
        }
      }

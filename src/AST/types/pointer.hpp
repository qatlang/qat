...
namespace qat {
namespace AST {
class PtrType : public QatType {
private:
  QatType type;

public:
  PtrType(utilities::FilePosition _filePosition)
      : type(VoidType(_filePosition)), QatType(_filePosition, "pointer") {}

  PtrType(QatType _type, utilities::FilePosition _filePosition)
      : type(_type), QatType(_filePosition, "pointer") {}

...
#ifndef QAT_AST_TYPES_OBJECT_HPP
#define QAT_AST_TYPES_OBJECT_HPP
...
namespace qat {
namespace AST {
class ObjectType : public QatType {
public:
  ObjectType(std::string _name, utilities::FilePosition _filePosition)
      : name(_name), QatType(_filePosition, "object") {}

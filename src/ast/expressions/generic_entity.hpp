...
class GenericEntity final : public Expression {
  ...
  public:
	...
	static GenericEntity* create(u32 _relative, Vec<Identifier> _names, Vec<FillGeneric*> _genericTypes,
	...
	NodeType nodeType() const final { return NodeType::GENERIC_ENTITY; }
};

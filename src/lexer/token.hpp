...
namespace qat
{
    namespace lexer
    {
        ...
        public:
            ...
            /**
             * @brief Whether this token represents a value. This is necessary as the value can
             * just be an empty string and cannot be considerd as no value in that case.
             */
            bool hasValue = false;

...
public:
  IntType(const utilities::FilePosition _filePosition)
      : bitWidth(64), QatType(_filePosition, "int") {}

  IntType(const unsigned int _bitWidth, const utilities::FilePosition _filePosition)
      : bitWidth(_bitWidth), QatType(_filePosition, "int") {}
